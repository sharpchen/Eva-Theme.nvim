...
local function treesitter(h)
    h
        :map_token('type',
            { '@attribute', '@constructor', '@type.definition', '@tag.attribute', '@markup.list.markdown' })
        :map_token('func',
